    ...
    <footer className="bg-catering-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-10 mb-8">
          <div>
            <h3 className="font-playfair text-xl font-bold mb-4">Pacific Island Catering</h3>
          ...
          <div>
            ...
            <address className="not-italic font-montserrat text-sm text-gray-300 space-y-2">
              ...
              <p>Email: info@pacificislandcatering.com</p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8 mt-8 text-center">
          <p className="font-montserrat text-sm text-gray-400">
            &copy; {currentYear} Pacific Island Catering. All rights reserved.
          </p>
