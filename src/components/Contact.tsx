    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="font-montserrat text-gray-600">(555) 123-4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="font-montserrat text-gray-600">info@pacificislandcatering.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="font-montserrat text-gray-600">Monday - Friday: 9am - 5pm</p>
                  <p className="font-montserrat text-gray-600">Saturday: 10am - 3pm</p>
                  <p className="font-montserrat text-gray-600">Sunday: Closed</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <form className="space-y-6 bg-catering-light p-8 rounded-lg shadow-md">
              <div>
              ...
              <Button 
                type="submit" 
                className="bg-catering-primary hover:bg-catering-secondary text-white w-full py-6"
              >
